...
export function SplashScreen({ onComplete }: SplashScreenProps) {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-gradient-to-br from-[#0a0a0f] via-[#1e2a3a] to-[#1a2634]">
        ...
        {[...Array(30)].map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              background: `radial-gradient(circle, ${i % 3 === 0 ? '#06b6d4' : i % 3 === 1 ? '#3b82f6' : '#10b981'
                }, transparent)`,
            }}
            animate={{
              opacity: [0.2, 0.8, 0.2],
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full">
        ...
        >
          <h1 className="text-6xl font-bold text-gray-100 mb-3 tracking-tight">
            SRIKA
          </h1>
